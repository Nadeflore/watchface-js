...
hmUI.createWidget(hmUI.widget.TEXT_IMG, { x: 72, y: 445, h_space: 1, font_array: ['images/11.png', 'images/12.png', 'images/13.png', 'images/14.png', 'images/15.png', 'images/16.png', 'images/17.png', 'images/18.png', 'images/19.png', 'images/20.png'], align_h: hmUI.align.CENTER_H, type: hmUI.data_type.WEATHER_CURRENT, unit_en: 'images/63.png', negative_image: 'images/61.png', show_level: hmUI.show_level.ONLY_NORMAL
})
weatherWidget = hmUI.createWidget(hmUI.widget.TEXT_IMG, { x: 72, y: 424, h_space: 0, font_array: ['images/88.png', 'images/89.png', 'images/90.png', 'images/91.png', 'images/92.png', 'images/93.png', 'images/94.png', 'images/95.png', 'images/96.png', 'images/97.png'], align_h: hmUI.align.CENTER_H, unit_en: 'images/99.png', negative_image: 'images/98.png', dot_image: 'images/100.png', show_level: hmUI.show_level.ONLY_NORMAL
})
